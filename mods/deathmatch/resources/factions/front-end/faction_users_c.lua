...
function factionSystemRol()
	...
	dxDrawText("Birlik Rolleri",x+95,y,w,h,white,1,fontazzardo)
	dxDrawText("Düzenlemek istediğiniz permin üzerine tıklayın.",x+30,yx+220,w,h,white,1,fontroboto)
	...
	dxDrawText("Akademi",x+45,yx-19,w,h,white,1,fontroboto)
	dxDrawText("150$",x+265,yx-19,w,h,white,1,fontroboto)

	if isCursorOnElement(x+290,y+2,30,30) then 
		dxDrawText("",x+290,y+2,w,h,tocolor(220,0,0),1,fontawesome)
	end
end
--addEventHandler("onClientRender",root,factionSystemRol)
