...
function panel()
	...
	if karakterler[1] then
		for k,v in pairs(karakterler) do 
			...
			dxDrawText(v.charName:gsub("_"," "),x+13,y-122 + (k * 40)+50 ,w,h,tocolor(200,200,200,alpkha2),1,robotomed) -- 1. karakter adı
		...
		dxDrawText('Hiçbir karakteriniz yok :( Oluşturman için sağ altta bir buton var, ona tıkla!', x+16, y-22.7, w+x, h+y, tocolor(200, 200, 200, alphka2), 1, robotomed)
	end
